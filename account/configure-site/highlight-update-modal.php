...
include '../../connection.php';
                    ...
                    $id = $_REQUEST['id'];
                      ...
                      $get = mysqli_query($conn,"SELECT * FROM highlighter WHERE id='$id'");
    ...
    <br>
                <form id="modalform" name="modalform" action="code/delete.php" class="form-horizontal calender" method="POST">
                    ...
                    <div class="form-group">
                        <label class="col-sm-4 control-label">Highlight Description <span class="required">*</span></label>
                        <div class="col-sm-4">
                            <input type="text" value = "<?php echo $desc1; ?>" class="form-control" id="desc1" name="desc1">                            
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-4 control-label">Active <span class="required">*</span></label>
                        <div class="col-sm-4">
                            <input id="act" type="checkbox" name="act" value="checked" /><label for="txtact">Is Active</label>                            
                        </div>
                    </div>
