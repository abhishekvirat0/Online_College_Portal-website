...
include '../../connection.php';
                    ...
                    $id = $_REQUEST['id'];
                      ...
                      $get = mysqli_query($conn,"SELECT * FROM ranker WHERE vid='$id'");
    ...
    <br>
                <form id="modalform" name="modalform" action="code/delete.php" class="form-horizontal calender" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" value = "<?php echo $url; ?>" class="form-control" id="url" name="url">                            
                        </div>
                    </div>
                    <div class="form-group">
      ...
      <div class="form-group"> 
          <label class="col-sm-4 control-label">Speaker <span class="required">*</span></label>
         <div class="col-sm-4">
            <select class="form-control" id="speaker" name="speaker">
              <option value="0">Select Speaker Type</option>
...
<script type="text/javascript">
 $(document).ready(function(){
  ...
  $('#update').click(function(event) {
    ...
    {
      infoAlert("Please Select Speaker");
    }
    else
    {
        $.ajax({
            type: 'POST',
            url: 'add-video-update-code.php',
            data: ({ id: id, url2: url2, title: title, speak: speak }),
