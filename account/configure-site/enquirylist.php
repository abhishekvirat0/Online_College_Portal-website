...
<head>
  ...
  <title>Manage people queries </title>
        ...
        <div>
          ...
          <table id="example" class="table table-striped table-bordered cell-border" cellspacing="0" width="100%">
            ...
            <tbody>
              ...
              $get2 = mysqli_query($conn,"SELECT * FROM enquiry");
         ...
         $.ajax({
           ...
           success: function(response) {
             ...
             if(response == "1" || response == 1 )
             {
               ...
               setTimeout(function(){
                 window.location.href='enquirylist.php';
               }, 1000);
             }
             else
             {
