...
<head>
  ...
  <script type="text/javascript">
      ...
      {
        setTimeout(function(){
          $('#light_box').load('news-update-modal.php?id='+id); /*Modal Content Load from page location*/
      ...
      <table class="table table-bordered">
        ...
        <tr>
           <?php
                                     ...
                                     $result = mysqli_query($conn,"SELECT MAX(Id)+1 FROM news");
         ...
         <tr>
         <td><span style="color: #3973ac; font-weight: bold; ">Author name</span></td>
          <td><input type="text" name="name1" id="name1" class="form-control" >
          </td>
          </tr>
        <tr>
...
<?php
              ...
              $get2 = mysqli_query($conn,"SELECT * FROM news");
...
function delete_row(id)
{
  ...
  $(document).ready(function() {  
    ...
    if(name1=='')
    {
      infoAlert("Please enter your name");
    }
  else
  {
    $.ajax({
         type: 'POST',
         url: 'newsdetail2.php',
         data: ({id:id, title1:title1, detail:detail, date:date, name1:name1}),
