...
<head>
  ...
  <?php include '../../assets/dashboard-assets-css.php'; ?>
    ...
    <script type="text/javascript">
      ...
      {
        setTimeout(function(){
          $('#light_box').load('add-state-update-modal.php?id='+id); /*Modal Content Load from page location*/
  ...
  <div class="content-wrapper" style="background-color: #ffffff; ">
    ...
    <div class="panel panel-default">
      ...
      <table class="table table-bordered">
        <tr>
          <th colspan="4" class="panel-heading" style="font-weight: bold; text-align: center;">State</th>
        </tr>   
        <tr>
        ...
        <tr>
         <!-- <td><span style="color: #3973ac; font-weight: bold; ">Select Course</span></td>
          ...
          <form class="submitphoto_form" method="post" action="add-state.php">
                <?php
                                     
                                     $result = mysqli_query($conn,"SELECT MAX(Id)+1 FROM states");
                                     $row = mysqli_fetch_row($result);
                                     $highest_id = $row[0];
                                    ?>
                 <input type="hidden" value="<?php echo  $highest_id ; ?>" class="wp-form-control wpcf7-text" id="Id" name="Id" >               
          <td><span style="color: #3973ac; font-weight: bold; ">Add State</span></td>
          <td><input type="text" name="Name" id="Name" class="form-control" style="width: 200px" >(<font color="#DB2929" style="font-size: small">e.g.- Maharashtra</font>)<span id="spnError" style="color: Red; display: none">*Enter Characters Only.</span>
          </td>
        </tr>
...
<?php
              ...
              $get2 = mysqli_query($conn,"SELECT * FROM states");
