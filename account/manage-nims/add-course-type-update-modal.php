...
include '../../connection.php';
                    ...
                    $id = $_REQUEST['id'];
                      ...
                      $get = mysqli_query($conn,"SELECT * FROM coursetype WHERE cid='$id'");
  ...
  <div class="modal-content" style="border-radius: 0px;">
    ...
    <br>
                <form id="modalform" name="modalform" action="code/delete.php" class="form-horizontal calender" method="POST">
                    ...
                    <div class="form-group">
                        <label class="col-sm-4 control-label">Course Type <span class="required">*</span></label>
                        <div class="col-sm-4">
                            <input type="text" value = "<?php echo $course_type; ?>" class="form-control" id="course_type" name="course_type">                            
                        </div>
                    </div>
 ...
 $(document).ready(function(){
  ...
  $('#update').click(function(event) {
    ...
    else
    {
        $.ajax({
            type: 'POST',
            url: 'add-course-type-update-code.php',
            data: ({ id: id, course_nm: course_nm, course_type: course_type }),
