...
include '../../connection.php';
                    ...
                    $id = $_REQUEST['id'];
                      ...
                      $get = mysqli_query($conn,"SELECT * FROM referencetype WHERE cid='$id'");
    ...
    <br>
                <form id="modalform" name="modalform" action="code/delete.php" class="form-horizontal calender" method="POST">
                    ...
                    <div class="form-group">
                        <label class="col-sm-4 control-label">Year <span class="required">*</span></label>
                        <div class="col-sm-4">
                            <input type="text" value = "<?php echo $name1; ?>" class="form-control" id="name1" name="name1">                            
                        </div>
                    </div>
 ...
 $(document).ready(function(){
  ...
  $('#update').click(function(event) {
    ...
    else
    {
        $.ajax({
            type: 'POST',
            url: 'add-reference-update-code.php',
            data: ({ id: id, name1: name1 }),
