...
include '../../connection.php';
                    ...
                    $id = $_REQUEST['id'];
                      ...
                      $get = mysqli_query($conn,"SELECT * FROM occupation WHERE id='$id'");
    ...
    <br>
                <form id="modalform" name="modalform" action="code/delete.php" class="form-horizontal calender" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" value = "<?php echo $occupation; ?>" class="form-control" id="occupation" name="occupation">                            
                        </div>
                    </div>

                    <div class="form-group">
                      <label class="col-sm-4 control-label" for="chkIsMother">Is Mother <span class="required">*</span></label>
                      <div class="col-sm-2">
                        <input id="chkIsMother" type="checkbox" name="chkIsMother" value="checked" />
                      </div>
...
<script type="text/javascript">
 $(document).ready(function(){
  ...
  $('#update').click(function(event) {
    ...
    if (occupation=='') 
    {
      infoAlert("Please Enter Occupation");
    }
    else
    {
        $.ajax({
            type: 'POST',
            url: 'occupation-update-code.php',
            data: ({ id: id, occupation: occupation, chkIsMother: chkIsMother }),
