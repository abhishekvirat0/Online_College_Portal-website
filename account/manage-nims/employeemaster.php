...
<?php include '../../assets/dashboard-assets-js.php'; ?>
  ...
  <script type="text/javascript">
      ...
      {
        setTimeout(function(){
          $('#light_box').load('employeemaster-update-modal.php?id='+id); /*Modal Content Load from page location*/
...
<div class="wrapper">
  ...
  <div class="content-wrapper" style="background-color: #ffffff; ">
    ...
    <form method="post" name="myForm" id="myForm" action="employeemaster2.php" onsubmit="return validateForm()" enctype="multipart/form-data">
      <table class="table table-bordered">
        <tr>
          <td><th colspan="6" class="panel-heading" style="font-weight: bold; text-align: center;">Add Employee</th></td>
           </tr>
        <tr>
        ...
        <tr>
                                  <?php
                                     ...
                                     $result = mysqli_query($conn,"SELECT MAX(id)+1 FROM employeemaster");
                                     $row = mysqli_fetch_row($result);
                                     $highest_id = $row[0];
                                    ?>
          <td><input type="hidden" name="txtcid" value="<?php echo   $highest_id; ?> " id="txtcid" class="form-control">

          <td><span style="color: #3973ac; font-weight: bold; ">Employee Name</span></td>
          ...
          <td><span style="color: #3973ac; font-weight: bold; ">Education</span></td>
            ...
            <td><input type="text" name="txtsub" id="txtsub" class="form-control"><font color="#DB2929" style="font-size: small"></font><span id="spnError" style="color: Red; display: none">*Enter Characters Only.</span>
          ...
          <td> 
            ...
            <td><input type="text" name="txtcno" id="txtcno" class="form-control"><font color="#DB2929" style="font-size: small"></font><span id="spnError" style="color: Red; display: none">*Enter Characters Only.</span>
                   ...
                   <tr><td><td><span style="color: #3973ac; font-weight: bold; ">Payment</span></td>  
                               <td><input type="text" name="txtpayment" id="txtpayment" class="form-control"><font color="#DB2929" style="font-size: small"></font><span id="spnError" style="color: Red; display: none">*Enter Characters Only.</span></td>
...
<?php
              ...
              $get2 = mysqli_query($conn,"SELECT * FROM employeemaster");
              while($row2 = mysqli_fetch_array($get2))
              {

                $id=$row2['id'];
                $employee_nm=$row2['ename'];
                $education=$row2['edu'];
                $subject=$row2['sub'];
                $cno=$row2['cno'];
                $image=$row2['pic'];
...
?>      
        <div id="tbl_row">
          <tr>
            <td><?php echo $id; ?></td>
            <td><img src="empimages/<?php echo $image; ?>" width="100" height="100" alt="Planets"></td>
            <td><?php echo $employee_nm; ?></td>
      ...
      $.confirm({
        ...
        buttons: {
            confirm: function () {
               ...
               $.ajax({
               type: 'POST',
               url: 'employeemaster-delete-code.php',
               data: ({ id: id }),
