...
<script type="text/javascript">
      ...
      {
        setTimeout(function(){
          $('#light_box').load('add-reference-update-modal.php?id='+id); /*Modal Content Load from page location*/
...
<div class="wrapper">
  ...
  <div class="content-wrapper" style="background-color: #ffffff; ">
    ...
    <form method="post" action="reference-type.php">
      <table class="table table-bordered">
        <tr>
        <td>
          <th colspan="4" class="panel-heading" style="font-weight: bold; text-align: center;">Reference</th></td>
        </tr>   
        <tr>
        ...
        <?php
          ...
          <td><span style="color: #3973ac; font-weight: bold; ">Add Reference</span></td>
          <td><input type="text" name="txtreference" id="txtreference" class="form-control" style="width: 200px">(<font color="#DB2929" style="font-size: small">e.g.- Internet</font>)<span id="spnError" style="color: Red; display: none">*Enter Characters Only.</span>
          </td>
        </tr>
...
<?php
              ...
              $get2 = mysqli_query($conn,"SELECT * FROM referencetype");
...
function delete_row(id)
{
      ...
      $.confirm({
        ...
        buttons: {
            confirm: function () {
               ...
               $.ajax({
               type: 'POST',
               url: 'add-reference-delete-code.php',
               data: ({ id: id }),
               ...
               if(response == "1" || response == 1 )
               {
                 ...
                 setTimeout(function(){
                   window.location.href='reference-type.php';
                 }, 1000);
               }
               else
               {
  ...
  $(document).ready(function() {  
    ...
    var reference1=$('#txtreference').val();
    ...
    if(reference1=='')
    {
      infoAlert("Please Enter Reference");
    }
  else
  {
    $.ajax({
         type: 'POST',
         url: 'reference-type2.php',
         data: ({cid:cid, reference1:reference1}),
         success: function(response3) 
     {
             if(response3 == "1")
            {  
              $('.modal-body').html("Reference Added Successfully");
                 $("#myModal").modal();   
                  setTimeout(function(){
                  window.location.href='reference-type.php';
                  }, 1000); 
             ...
             {
                 $('.modal-body').html("Reference Not Added");
                 $("#myModal").modal();
             }
         }
      });
