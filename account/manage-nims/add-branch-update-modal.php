...
include '../../connection.php';
                    ...
                    $id = $_REQUEST['id'];
                      ...
                      $get = mysqli_query($conn,"SELECT * FROM branch WHERE BId='$id'");
  ...
  <div class="modal-content" style="border-radius: 0px;">
    ...
    <br>
                <form id="modalform" name="modalform" action="code/delete.php" class="form-horizontal calender" method="POST">
                    ...
                    <div class="form-group">
                        <label class="col-sm-4 control-label">Select Class <span class="required">*</span></label>
                        <div class="col-sm-4">
            ...
            ?>
                    ...
                    <div class="form-group">
                        <label class="col-sm-4 control-label">Branch Name <span class="required">*</span></label>
                        <div class="col-sm-4">
                            <input type="text" value = "<?php echo $branch_nm; ?>" class="form-control" id="branch_nm" name="branch_nm">                            
                        </div>
                    </div>
 ...
 $(document).ready(function(){
  ...
  $('#update').click(function(event) {
    ...
    else
    {
        $.ajax({
            type: 'POST',
            url: 'add-branch-update-code.php',
            data: ({ id: id, course_nm: course_nm, class_nm: class_nm, branch_nm: branch_nm }),
