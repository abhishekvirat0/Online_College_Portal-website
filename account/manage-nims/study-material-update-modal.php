...
include '../../connection.php';
                    ...
                    $id = $_REQUEST['id'];
                      ...
                      $get = mysqli_query($conn,"SELECT * FROM studymaterial WHERE cid='$id'");
                      while($row = mysqli_fetch_array($get))
                      {
                        $study_material=$row['Name'];
                      }
    ...
    <br>
                <form id="modalform" name="modalform" action="code/delete.php" class="form-horizontal calender" method="POST">
                    ...
                    <div class="form-group">
                        <label class="col-sm-4 control-label">Study Material <span class="required">*</span></label>
                        <div class="col-sm-4">
                            <input type="text" value = "<?php echo $study_material; ?>" class="form-control" id="study_material" name="study_material">                            
                        </div>
                    </div>
 ...
 $(document).ready(function(){
  ...
  $('#update').click(function(event) {
    ...
    else
    {
        $.ajax({
            type: 'POST',
            url: 'study-material-update-code.php',
            data: ({ id: id, study_material: study_material }),
