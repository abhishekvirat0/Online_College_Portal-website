        ...
        <div class="section-content">
          <div class="row"> 
            <div class="col-md-6">
              ...
              <h3><span style="color:white;">Hi, </span><span class="text-theme-colored2"><b>Student Name</b><span></h3>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-md-2">
            <div class="vertical-tab">
              <ul class="nav nav-tabs">
                <li><a href="#tab16" data-toggle="tab">Lecture Schedule</a></li>
                <li><a href="#tab17" data-toggle="tab">Test Schedule</a></li>
                <li class="active"><a href="#tab18" data-toggle="tab">Result $ Analysis</a></li>
          ...
          <div class="col-md-10">
            <div class="tab-content">
              ...
              <div class="tab-pane fade in active" id="tab18">
                <div class="row">
                  <div class="col-md-12">                          
